...
export default function LeadTest-corp-test-899901Dashboard() {
  const [leadStatus, setLeadStatus] = useState('active');
  const [isHot, setIsHot] = useState(true);
  const [followUpScheduled, setFollowUpScheduled] = useState(false);

  const leadData = {
  "id": "lead_1749736899900_9qrrva0wh",
  "slug": "test-corp-test-899901",
  ...
  "source": "demo",
  "capturedAt": "2025-06-12T14:01:39.900Z",
  "interactions": [
    {
      "type": "lead_captured",
      "timestamp": "2025-06-12T14:01:39.901Z",
      "details": "Lead captured from demo",
      "value": 30
    }
  ],
  "qnisScore": 83,
